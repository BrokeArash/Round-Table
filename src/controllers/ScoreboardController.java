    ...
    public Result sort(String sortType) {
        ...
        if ((sortType == null) || (sortType.isEmpty())) {
            ...
            for (Player player : App.getPlayers()) {
                stringBuilder.append(player.getName()).append("-> ").append("points: ").append(player.getPoint()).append("\n");
            }
            ...
            for (Player player : App.getPlayers()) {
                stringBuilder.append(player.getName()).append("-> ").append("games played: ").append(player.getGamesPlayed()).append("\n");
            }
            ...
            for (Player player : App.getPlayers()) {
                stringBuilder.append(player.getName()).append("-> ").append("total damage dealt : ").append(player.getDamageDealt()).append("\n");
            }
            ...
            for (Player player : App.getPlayers()) {
                stringBuilder.append(player.getName()).append("-> ").append("games won : ").append(player.getGamesWon()).append("\n");
            }
        } else {
            return new Result(false, "invalid sort type");
        }
